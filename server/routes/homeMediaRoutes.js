...
// תיקון הייבוא: שימוש בקובץ הקיים authMiddleware ושימוש בפונקציות המקובלות protect, admin
...
// שימוש ב-protect ו-admin כדי לאבטח את הנתיב
router.put("/admin/homepage-media", protect, admin, async (req, res) => {
  try {
