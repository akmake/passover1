...
export const logoutUser = async (req, res) => {
    try {
        // --- התיקון כאן ---
        // אנחנו בודקים אם יש משתמש (req.user) לפני שאנחנו מנסים לגשת ל-_id שלו.
        // זה מונע את הקריסה במקרה שהמשתמש מנסה להתנתק כשהטוקן שלו כבר פג תוקף.
        ...
        // נקה את העוגיות בכל מקרה (גם אם לא מצאנו משתמש)
