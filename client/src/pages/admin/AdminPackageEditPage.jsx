...
const AdminPackageEditPage = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                setFixedItems(pkg.fixedItems.map(item => ({
                    ...
                    _productDetails: item.product // אם זה כבר מאוכלס
                })));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const packageData = { name, price: Number(price), description, isActive, fixedItems: validFixedItems, choiceRules: sanitizedRules };
        ...
        <div className="max-w-5xl mx-auto pb-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-end gap-4 pt-6 border-t border-gray-200">
                    ...
                    <Button type="submit" disabled={submitting} className="px-8 text-lg">
                        {submitting ? <LoaderCircle className="animate-spin" /> : 'שמור שינויים'}
                    </Button>
                </div>
            </form>
